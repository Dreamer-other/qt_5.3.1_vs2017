...
template<typename _kt, typename _vt, 
	typename _CompareNameFix,
	typename _EqualDummy,
	typename _KeyDeletor=CL_NS(util)::Deletor::Dummy,
	typename _ValueDeletor=CL_NS(util)::Deletor::Dummy>
class CLHashMap:public __CLMap<_kt,_vt,
	CL_NS_STD(map)<_kt,_vt, _CompareNameFix>,
	_KeyDeletor,_ValueDeletor>
{
	typedef typename CL_NS_STD(map)<_kt,_vt,_CompareNameFix> _base;
	typedef __CLMap<_kt, _vt, CL_NS_STD(map)<_kt,_vt, _CompareNameFix>,
